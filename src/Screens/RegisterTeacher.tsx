...
const RegisterTeacher: React.FC = () => {
  ...
  const [subject, setSubject] = useState(''); // Nuevo estado para la asignatura
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log({
      firstName, lastName, motherLastName, rut, age, subject,
    });
  ...
  return (
    <div style={styles.container}>
      ...
      {isSuccess && <p style={styles.successMessage}>¡Docente registrado con éxito!</p>}
